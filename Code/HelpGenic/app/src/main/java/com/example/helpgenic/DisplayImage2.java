...
public class DisplayImage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.connectToDb(DisplayImage2.this);
        ...
        if(db.isConnectionOpen()){
            ...
            if(documentId != 0){
                ...
                String byteData = db.loadDoctorDegreeImageFromDb(docId,DisplayImage2.this);
